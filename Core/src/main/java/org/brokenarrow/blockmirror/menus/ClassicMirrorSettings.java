...
public class ClassicMirrorSettings extends MenuHolder {
   ...
   public ClassicMirrorSettings(Player player, String menuName) {
      ...
      if (data != null && data.getCenterLocation() != null) {
         ...
         blockMirror.getBlockVisualize().visulizeBlock(data.getCenterLocation().getBlock(), data.getCenterLocation(), true);
         ...
         blockMirror.getPlayerCache().setPlayerData(player.getUniqueId(), builder.build());
      }
   }
